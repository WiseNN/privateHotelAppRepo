...
class HotelRoomReservationView(parentView: MyButtonBarView) : View()
{
...
//            isVisible = true
        ...
        splitpane {
            ...
            add(CalenderView(list, this@HotelRoomReservationView))
...
//            submitButtonColumn.prefWidthProperty().set(150.0)
        ...
        searchBookingBtn.setOnMouseClicked {
            ...
            rez.forEach {
                ...
                it.amenitiesProperty  = SimpleStringProperty(it.amenities)
                it.notesProperty = SimpleStringProperty(it.notes)
