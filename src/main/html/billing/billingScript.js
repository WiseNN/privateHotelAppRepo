class Billing {
	...
	createLineItemDescriptionTextCell(withText)
	{
		...
		spanElm.id = "roomDescriptionSpanText";
	...
	setRoomDescriptionTextBlock(withText)
	{
		...
		descrBlock.textContent = withText;
	}
	...
	setDateText(withText)
	{
		...
		purchaseDate.textContent = withText;
	}
	...
	setPurchaseTotalText(withText)
	{
		...
		purchaseTotalText.textContent = withText;
	}
